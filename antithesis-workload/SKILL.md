...
- No reach claim is the negation of an `Always` or `AlwaysOrUnreachable` at the same site, and each reach claim still fires when the system is correct (see `references/assertions.md`, "A Reach Claim Asserts The Precondition, Never The Violation")
